...
public class DcTracker extends Handler {
    ...
    private boolean isDataAllowed(DataAllowFailReason failureReason) {
        ...
        {
            if (DBG) log("allowed : force records loaded on CDMA phone" );
            recordsLoaded = true;
        }
        //SWISTOP
    ...
    private boolean setupData(ApnContext apnContext, int radioTech) {
        ...
        if (apnSetting == null) {            //SWISTART
            ...
            if(PhoneConstants.PHONE_TYPE_CDMA==mPhone.getPhoneType()) {
                ...
                apnSetting = new ApnSetting(apnId, getCDMAOperatorNumeric(), null, null,
    ...
    private String getCDMAOperatorNumeric() {
        String result;
        result = SystemProperties.get("ro.cdma.home.operator.numeric");
